...
#cfg.PATHS['climate_file'] = '/exports/csce/datastore/geos/groups/geos_iceocean/kinnear/SWARM_files/oggm_SWARM_input/oggm_swarm_input.nc'
...
WORKING_DIR = '/exports/csce/datastore/geos/groups/geos_iceocean/kinnear/oggm_runs/oggm_custom_climate_run_cru_1979'
...
#print(rgidf)
# Get the shapefile
basin = gpd.read_file('/exports/csce/datastore/geos/groups/geos_iceocean/kinnear/SWARM-OGGM-Model/shape_files/china_test.shp')
...
workflow.execute_entity_task(tasks.process_climate_data, gdirs,y0=1979,y1=2018)
