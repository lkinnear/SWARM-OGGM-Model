...
WORKING_DIR = '/exports/csce/datastore/geos/users/s0933963/China_test/'
...
# Get the shapefile
basin = gpd.read_file('/exports/csce/datastore/geos/users/s0933963/SWARM-OGGM-Model/shape_files/RiverBasinsMerged.shp')
...
rgidf.to_file('/exports/csce/datastore/geos/users/s0933963/China_test/rgidf.shp')
#COnvert to pandas dataframe then print
rgipdf = pd.DataFrame(rgidf)
rgipdf.to_csv('/exports/csce/datastore/geos/users/s0933963/China_test/rgipdf.csv')
