...
cfg.PARAMS['swarm_mu_method']= False
...
WORKING_DIR = '/exports/csce/datastore/geos/groups/geos_iceocean/dgoldber/oggm/oggm_runs/oggm_mswep_era_reference_run_nogeo'
if not os.path.exists(WORKING_DIR):
    os.makedirs(WORKING_DIR)
REF_DIR = '/exports/csce/datastore/geos/groups/geos_iceocean/dgoldber/oggm/oggm_runs/oggm_mb_calibration_ERA5_MSWEP_reference_period_nogeo'
...
workflow.execute_entity_task(tasks.run_from_climate_data, gdirs,mb_elev_feedback='monthly',
                             store_monthly_step=True,
                             output_filesuffix='_commitment',ys=1980,ye=2018)
