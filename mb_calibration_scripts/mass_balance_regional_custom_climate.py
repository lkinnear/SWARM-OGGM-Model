...
WORKING_DIR = '/exports/csce/datastore/geos/groups/geos_iceocean/kinnear/oggm_runs/oggm_mb_calibration_cru_rf_hgt'
...
execute_entity_task(tasks.process_climate_data, gdirs, y0=1979,y1=2018)
